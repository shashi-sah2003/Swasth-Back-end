...
app.get('/requestsettings', (req,res) =>{
   ...
   db.query("SELECT name, email, phoneNumber FROM user where userId = ? ", [userId] , (error, results, fields)=>{
       	if(error){
...
app.post('/updatesettings', async (req,res)=>{
    ...
    db.query('UPDATE user SET email = ?, phoneNumber= ? , password = ? WHERE userId = ?', [email, phoneNumber, hashedPassword, userId], (error, results, fields) => {
